    ...
    <div class="main_text">
		...
		<div id="ur_text">
         	...
         	<table width="609" border="0" cellspacing="0" cellpadding="0" class="mab30">
              ...
              <tbody><tr>
                <td width="96" rowspan="4" style="border-left:1px solid #e5e5e5;"><img src="img/조교_박지훈.jpg" width="99" height="115"></td>
                <td width="96"> 직책</td>
              ...
              <tr>
                <td>이메일</td>
                <td height="12"><a href="mailto:jh9108@hongik.ac.kr">jh9108@hongik.ac.kr</a></td>
              </tr>
			  </tbody></table>
