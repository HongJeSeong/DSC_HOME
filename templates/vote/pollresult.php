  	...
  	<table class ="cic_result_table">
		<?php
			while($cic_row = mysql_fetch_array($r1)){
				...
				$vote_per = 2000*($cic_row[3]/$vote_num);
				echo "<tr>
			<td class ='polldescripteioncell'>".$cic_row[1].",&nbsp".$cic_row[2]." </td>
...
<p style="margin-left: 300px;">Total votes: <?php echo "$vote_num";?> <br/><?php $count=$vote_num/4;echo "$count";?>명 참가</p>
