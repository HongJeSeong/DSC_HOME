...
<div class="main-container">
    ...
    <div class="main_text">
			<h3>이수체계도</h3>
		<p><strong class="style9"><a href="../../assets/files/sysgraph_2017.pptx">[이수체계표 다운로드]</a></strong></p>
	...
	<!--	<div id="underimg" style="display: inline"><strong class="style8">선후수관계 이수체계도 &nbsp;&nbsp;&nbsp;</strong></div>
		...
		<br>
		<div class="underimg"><img id="sysimg" src="../../assets/files/systemgraph2_2017.png" width="690" height="auto" alt="이수체계도"></div>
