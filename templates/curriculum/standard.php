...
<div class="main-container">
	<div class="curriculum-content" >
		<div class="main_text">
			...
			<table style="" bordercolor="#000000" cellpadding="10" cellspacing="0" class="mab30">
				...
				<tr>
					...
					<td> 가. 컴퓨터정보통신공학 프로그램에 속한 자는 “과학기술대학 공학교육인증과정 이수내규 제 11조(영어(외국어) 관련 요건)에 제시된 외국어 공인시험 중 하나를 응시하고, 유효기간 내의 성적표를 졸업사정 전까지 제출하여야 한다.<br> 
						나. 2012년 입학생까지는 시험별 인정 최저점수가 없으므로 점수에 무관하게 유효기간 내의 성적표를 제출하면 영어(외국어) 졸업요건을 만족한 것으로 인정한다.<br> 
						다. 2013년도 이후 입학생 중 과학기술대학에 속한 자는 공인영어능력시험평가에서 TOEIC 600점(또는 이에 상응하는 TOEFL, TEPS, NEW TEPs, TOEIC Speaking, OPIc 등의 점수)이상을 취득하고, 성적표를 제출하여야 한다.<br> 
						라. 영어(외국어) 관련 요건을 충족시키지 못한 자는 교과목 이수를 통하여 졸업요건을 만족한 것으로 인정한다.(과학기술대학 공학교육인증과정 이수내규 제 11조(영어(외국어) 관련 요건)참고)
					</td>
				</tr>
				<tr>
      ...
      <td>43</td>
						...
						<br>** 공인 어학 점수의 대체 방법으로 아래 사항 중 하나를 만족할 경우 어학 졸업요건을 만족한 것으로 인정함.<br>  - 대체방법 1: '실용영어(1)'및 '실용영어(2)' 이수<br>  - 대체방법 2: '생활영어(1)' 및 '생활영어(2)' 이수<br>  - 대체방법 3: '교양중국어(1)' 및 '교양중국어(2)' 이수<br>  - 대체방법 4 : '교양일본어(1)' 및 '교양일본어(2)' 이수</th>
				</tr>
